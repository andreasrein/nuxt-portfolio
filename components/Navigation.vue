...
<template>
  <nav class="z-10 fixed right-0 flex flex-col items-end text-white font-thin h-full">
    ...
    <div v-if="isOpen" class="relative z-10 p-8 h-full bg-white/10 transition-all">
